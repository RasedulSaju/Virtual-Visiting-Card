            ...
            try {
                ...
                if (!$mailer->isConfigured()) {
                    ...
                    $html  = Mailer::buildHtml(
                        'SMTP Test Email',
                        '<p>This is a test email from <strong>' . e(APP_NAME) . '</strong>.</p>
                         <p>If you received this, your SMTP configuration is working correctly.</p>'
                    );
                    $mailer->send($testEmail, $testEmail, 'SMTP Test — ' . APP_NAME, $html);
            ...
            <div class="card-body p-0">
                <table class="table table-sm mb-0">
                    <tbody>
                        ...
                        <tr><td class="text-muted ps-4">App Name</td><td class="fw-semibold pe-4"><?= e(APP_NAME) ?></td></tr>
