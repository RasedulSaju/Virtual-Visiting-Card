...
$pages = getDB()->query(
    'SELECT id, slug, title, show_in_nav, nav_order, meta_robots, updated_at
...
<div class="card border-0 shadow-sm">
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
            <?php if (empty($pages)): ?>
                <tr><td colspan="7" class="text-center text-muted py-4">No pages yet.</td></tr>
            <?php endif; ?>
            ...
            <tr>
                ...
                <td>
                    <?php if (str_contains($p['meta_robots'], 'noindex')): ?>
                        <span class="badge bg-warning-subtle text-warning" title="<?= e(metaRobotsLabel($p['meta_robots'])) ?>">
                            <i class="fas fa-eye-slash me-1"></i>noindex
                        </span>
                    <?php else: ?>
                        <span class="badge bg-success-subtle text-success" title="<?= e(metaRobotsLabel($p['meta_robots'])) ?>">
                            <i class="fas fa-search me-1"></i>indexed
                        </span>
                    <?php endif; ?>
                </td>
